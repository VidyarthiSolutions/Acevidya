      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 features-img">
            <img src="<?=base_url('assets/img/Landing_Page/product-features.png')?>" alt="" class="wow fadeInLeft">
          </div>
    ...
    <section id="advanced-features">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="<?=base_url('assets/img/Landing_Page/advanced-feature-1.jpg')?>" alt="">
      ...
      <div class="features-row">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-left" src="<?=base_url('assets/img/Landing_Page/advanced-feature-2.jpg')?>" alt="">
      ...
      <div class="features-row section-bg">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="<?=base_url('assets/img/Landing_Page/advanced-feature-3.jpg')?>" alt="">
              <div class="wow fadeInLeft">
                <h2>Duis aute irure dolor in reprehenderit in voluptate velit esse</h2>
                <h3>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
    ...
    <section id="clients">
      <div class="container">
        ...
        <div class="row wow fadeInUp">
          ...
          <div class="col-md-2">
            <img src="<?=base_url('assets/img/Landing_Page/clients/client-1.png')?>" alt="">
          </div>

          <div class="col-md-2">
            <img src="<?=base_url('assets/img/Landing_Page/clients/client-2.png')?>" alt="">
          </div>

          <div class="col-md-2">
            <img src="<?=base_url('assets/img/Landing_Page/clients/client-3.png')?>" alt="">
          </div>

          <div class="col-md-2">
            <img src="<?=base_url('assets/img/Landing_Page/clients/client-4.png')?>" alt="">
          </div>

          <div class="col-md-2">
            <img src="<?=base_url('assets/img/Landing_Page/clients/client-5.png')?>" alt="">
          </div>

          <div class="col-md-2">
            <img src="<?=base_url('assets/img/Landing_Page/clients/client-6.png')?>" alt="">
          </div>
